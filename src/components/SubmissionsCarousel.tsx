...
export default function SubmissionsCarousel({ submissions, className }: SubmissionsCarouselProps) {
            ...
            >
                <CarouselContent className="p-1">
                    {localSubmissions.map((submission) => (
                        <CarouselItem key={submission.id} className="md:basis-1/2 lg:basis-1/3">
